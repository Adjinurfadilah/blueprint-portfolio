...
const appCss = "/blueprint-portfolio/assets/styles-CWj0OvPN.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Mechanical Drafter — Portfolio" },
      { name: "description", content: "Portfolio of a Mechanical Engineering graduate specializing in technical drawing, CAD drafting, and manufacture-ready mechanical drawings." },
      { property: "og:title", content: "Mechanical Drafter — Portfolio" },
      { property: "og:description", content: "Blueprint-style portfolio for a Mechanical Engineering graduate / Drafter." },
...
const $$splitComponentImporter = () => import("./index-DmRfAC7y.js");
