...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B0fMEALg.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DZ5YJ0CX.js"),
    import("./start-CcvYfQFJ.js"),
...
var ROUTER_BASEPATH = "blueprint-portfolio";
var SERVER_FN_BASE = "/blueprint-portfolio/_serverFn/";
